...
class SafariSimulator(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.catchProbLabel.pack(fill="x", padx=4, pady=4)
        run = int(self.poke.speed)
        self.run_m = 2*run/256
        self.run_m *=100
        self.run_m = int(self.run_m)
        self.catchRunLabel = tk.Label(bg="grey")
        self.catchRunLabel["text"] = "The chance of the pokemon Fleeing is " + str(self.run_m) + "%!"
        self.catchRunLabel.pack(fill="x", padx=4, pady=4, side = "bottom")
    ...
    def throwBall(self):
        ...
        if r < m:
            ...
            if r < n:
                self.catchProbLabel["text"] = "It ran away"
                self.run()
        if self.ballsLeft == 0:
            self.endAdventure()
        #This method must:
    ...
    def endAdventure(self):
        ...
        self.catchRunLabel.pack_forget()
    ...
    def run(self):
        print("YUUUUH")
        self.catchRunLabel["text"] = "It ran away"
        self.catchRunLabel.after(5000, self.nextPokemon())
